...
(New-Object System.Net.WebClient).DownloadFile('https://www.microsoft.com/net/download/thank-you/dotnet-sdk-1.1.5-windows-x64-installer', "$env:appveyor_build_folder\dotnet-core-sdk.exe")
